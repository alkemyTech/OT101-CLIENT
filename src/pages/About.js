...
function About() {
  ...
  return (
    <>
      ...
      <Typography variant='h3' component='h2' sx={{marginBottom: 4, fontFamily: 'Signika'}}>Vision</Typography>
      ...
      <Typography variant='h3' component='h2' sx={{marginBottom: 4, fontFamily: 'Signika'}}>Mision</Typography>
